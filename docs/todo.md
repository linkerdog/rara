...
- [ ] Complete canonical pending-input/approval interaction fencing and real
      skill registration through SkillManager/SkillTool before advertising those
      methods. Bounded prompt sources, replay cursors, turn-targeted stop and
      retained shutdown outcomes are implemented.
