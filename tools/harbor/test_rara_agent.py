...
class RaraAgentTests(unittest.TestCase):
    ...
    def test_run_wraps_instruction_with_benchmark_artifact_guidance(self) -> None:
        ...
        self.assertIn("background process, daemon, or network service", uploaded_instruction)
        self.assertIn("fresh independent client process", uploaded_instruction)
        self.assertIn("process listing alone does not prove", uploaded_instruction)
